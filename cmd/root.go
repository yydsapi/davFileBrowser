...
import (
	"crypto/tls"
	"davFileBrowser/auth"
	"davFileBrowser/diskcache"
	"davFileBrowser/frontend"
	fbhttp "davFileBrowser/http"
	"davFileBrowser/img"
...
func addServerFlags(flags *pflag.FlagSet) {
	...
	flags.StringP("port", "p", "7086", "port to listen on")
	flags.StringP("cert", "t", "", "tls certificate")
	flags.StringP("key", "k", "", "tls key")
	flags.StringP("root", "r", "V:\\Test\\Movies", "root to prepend to relative paths") //yyds
